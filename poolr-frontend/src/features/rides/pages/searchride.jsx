...
import { useSearchRide } from "../hooks/useSearchRIde.js";

export default function SearchRide() {
  
  const {from, to, setFrom, setTo, fromSuggestions, toSuggestions, fromSelected, toSelected, setFromSelected, setToSelected, toObj, setToObj, fromObj, setFromObj, departureDate, setDepartureDate, seatsRequired, setSeatsRequired, handleSearchRides, rides, loading, error, hasSearched, setFromSuggestions, setToSuggestions} = useSearchRide();
